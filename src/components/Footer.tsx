          ...
          <div className="flex items-center gap-3">
            {resumeData.hero.socials.map((s) => (
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-xl border border-border text-muted-foreground transition-all duration-300 hover:border-primary hover:bg-primary/5 hover:text-primary"
              >
                {s.platform === "GitHub" ? (
